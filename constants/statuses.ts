...
export const ORDER_STATUSES: Record<OrderStatusKey, StatusConfig> = {
  received:    { key: 'received',    label: 'Received',    color: '#5C6E9E', bgColor: '#E7E9F4', step: 0 },
  ...
  embroidery:  { key: 'embroidery',  label: 'Embroidery',  color: Colors.gold, bgColor: Colors.goldLight, step: 3 },
  trial:       { key: 'trial',       label: 'Trial',       color: '#A04A6B', bgColor: '#F5E3EA', step: 4 },
  alterations: { key: 'alterations', label: 'Alterations', color: '#B5642B', bgColor: '#FBEADC', step: 5 },
...
export const STATUS_FLOW: OrderStatusKey[] = [
  'received', 'cutting', 'stitching', 'embroidery', 'trial', 'alterations', 'ready', 'delivered',
];

export const SKIPPABLE_STATUSES: OrderStatusKey[] = ['embroidery', 'trial', 'alterations'];
